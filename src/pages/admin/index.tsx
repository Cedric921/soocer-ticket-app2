		...
		<>
			...
			<div className='flex flex-wrap-reverse p-4'>
				<div className='w-full lg:w-2/3 py-2 lg:pr-2'>
					<div className='h-full bg-white rounded-xl border-2 duration-1000 p-1'>
						<div className='flex justify-between h-full'>
							...
							<div className='w-1/2 p-2'>
								<div className='rounded-2xl shadow-[0px_5px_10px_5px_#00000024] h-full border-black/80 border-2 p-2 relative'>
			...
			<div className='my-4 md:my-8'>
				<h3 className='text-xl font-semibold px-4'>Rencontres planifiées</h3>
