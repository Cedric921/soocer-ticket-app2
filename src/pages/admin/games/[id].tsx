	...
	return <div>
		...
		<div>
			...
			{game?.Reservation.map((reservation: IReservation, i: number) => (
				<>
					<div
						className={`flex ${i % 2 !== 0 ? 'bg-white dark:bg-black/50' : null
			...
			{game?.Reservation?.length < 1 ? <div className='text-center py-12 text-black dark:text-white'>
